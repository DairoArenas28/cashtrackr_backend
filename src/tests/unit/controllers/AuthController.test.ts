...
describe('AuthCOntroller.createAccount', () => {
    ...
    it('should return a 409 and an error message if the email is already resgistered', async () => {
        ...
        expect(data).toHaveProperty('error', 'Un usuario con ese email ya esta resgistrado')
