...
describe('BudgetController.getAll', () => {
    ...
    it('should retrieve 2 budgets por user with ID 1', async () => {
    ...
    it('should retrieve 1 budget por user with ID 2', async () => {
    ...
    it('should retrieve 0 budget por user with ID 10', async () => {
...
describe('BudgetController.create', () => {
    it('Should create a new budget and responsed with statusCode 201', async () => {
        const mockBudget = {
...
describe('BudgetController.updateById', () => {
    it('should update the budget and return a success message', async () => {
        ...
        const req = createRequest({
            ...
            url: '/api/budgets/:budgetId',
            budget: budgetMock,
            body: { name: "Presupuesto Actualizado", amount: 1500 }
        })
